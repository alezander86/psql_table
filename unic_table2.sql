select DISTINCT on (client_id) заключен, lastname, firstname, secondname, identifier as telephone, office, name as packet_name , stringval as inn, max_amount as las_summ , date_added as последний , loan_state as status_2_open_3_close
from 
...
and substring (microloan.full_number for 4) = 'ЗОБД')
...
GROUP BY заключен, client_id, date_added, office, name, lastname, firstname, secondname, loan_state, stringval, max_amount, identifier
